...
/** Test for {@link TimeWindowedCountAggFunc}. */
public class TimeWindowedCountAggFuncTest extends AbstractTimeWindowedAggFuncTest {

    @Test
    void testTimeWindowedCountAggFunc() {
        List<Row> expected =
    ...
    protected Class<? extends AbstractTimeWindowedAggFunc<?, ?>> getAggFunc() {
        return TimeWindowedCountAggFunc.class;
    }
}
